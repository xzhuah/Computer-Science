...
public class TitleForwardIndexer {
	...
	private static final String db_name="TitleForwardIndex";
	...
	public static void main(String[] args) throws IOException {
		//A demo of how to use this class
				//TitleForwardIndexer ivi=new TitleForwardIndexer();
			/*	ForwardIndexer.addURLWord(1, 1,1);
				...
				TitleForwardIndexer.addURLWord(2, 2,3);
				TitleForwardIndexer.addURLWord(1, 3,5);
				TitleForwardIndexer.addURLWord(3, 3,2);
				TitleForwardIndexer.addURLWord(4, 3,3);
				TitleForwardIndexer.addURLWord(2, 3,4);
				TitleForwardIndexer.addURLWord(3, 4,5);
				TitleForwardIndexer.addURLWord(1, 4,1);
				TitleForwardIndexer.addURLWord(1, 3,7);
				TitleForwardIndexer.delWordPosi(1, 3, 4);
				TitleForwardIndexer.delWord(1, 2);
				TitleForwardIndexer.delEntry(4);
				*/
				System.out.println(TitleForwardIndexer.getString());
				//System.out.println(TitleForwardIndexer.getAllURLID());
