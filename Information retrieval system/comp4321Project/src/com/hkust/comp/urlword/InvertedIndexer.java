...
public class InvertedIndexer {
	...
	private static final String db_name="InvertIndex";
	...
	*/
	...
	public static String getString() {
		...
		try {
			...
			Object setKey=it.next();
			while(setKey!=null){
				result+=(WordLib.getWord((int)setKey)+" -> ");
	...
	public static void main(String[] args) throws IOException {
		...
		/*InvertedIndexer.addWordURL(1, 1,4);
		InvertedIndexer.addWordURL(1, 1,2);
		InvertedIndexer.addWordURL(1, 1,1);
		InvertedIndexer.addWordURL(1, 1,3);
		InvertedIndexer.addWordURL(1, 2,1);
		InvertedIndexer.addWordURL(1, 3,1);
		InvertedIndexer.addWordURL(1, 4,1);
		
		InvertedIndexer.addWordURL(2, 1,1);
		InvertedIndexer.addWordURL(3, 1,2);
		InvertedIndexer.addWordURL(2, 1,2);
		InvertedIndexer.addWordURL(1, 1,3);
		InvertedIndexer.addWordURL(3, 2,4);
		InvertedIndexer.addWordURL(4, 3,5);
		InvertedIndexer.addWordURL(4, 4,5);*/
		System.out.println(InvertedIndexer.getString());
